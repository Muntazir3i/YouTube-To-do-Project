# YouTube To-Do Project

This project is a Frontend Mentor challenge focused on DOM manipulation and todo functionality. The main features of this project include:

- **Add Tasks**: Users can add new tasks to their to-do list.
- **Delete Tasks**: Users may remove tasks from their list as needed.
- **Mark Completed**: Users can mark tasks as completed, helping to track what has been finished.
